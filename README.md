...
### 🛡️ 7. تحدي العفة والتعافي (تعقب النقاء)
* **تعقب تلقائي ذكي:** عداد أيام التعافي من العادات السلبية (كالعادة السرية) يحسب تلقائياً أيام النقاء بناءً على ختم زمني مخزن في `localStorage`.
* **مستويات الرتب والنقاء:** الانتقال التلقائي بين مستويات التعافي (العزيمة، التطهير، الثبات، التحرر، النقاء).
* **سجل تاريخي للانتكاسات:** تسجيل تواريخ الزلات والمدة المحققة لتحليل مستوى الاستقرار وتلافي الأخطاء.
* **جرعات تحفيزية:** عرض نصوص إيمانية مقتبسة من القرآن الكريم والسنة النبوية للحث على غض البصر والصبر.
